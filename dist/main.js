...
class DateInputModal extends obsidian.Modal {
    onSubmit;
    settings;
...
class JournalOnlyModal extends obsidian.Modal {
    onSubmit;
    settings;
    constructor(app, onSubmit, settings) {
        super(app);
...
class EventLoggerSettingTab extends obsidian.PluginSettingTab {
    plugin;
...
class EventLoggerPlugin extends obsidian.Plugin {
    ...
    async addToJournal(inputDate, formattedString) {
        ...
        if (journalFile instanceof obsidian.TFile) {
